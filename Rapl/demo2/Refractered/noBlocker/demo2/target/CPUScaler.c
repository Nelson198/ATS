...
JNIEXPORT jint JNICALL Java_java_UmCarroJaApp_ProfileInit(JNIEnv *env, jclass jcls) {
	jintArray result;
	int i;
	...
	/*only two doUmCarroJaApps are supported for parameters check*/
...
JNIEXPORT jint JNICALL Java_UmCarroJaApp_GetSocketNum(JNIEnv *env, jclass jcls) {
	return (jint)getSocketNum();
}


JNIEXPORT jstring JNICALL Java_UmCarroJaApp_EnergyStatCheck(JNIEnv *env,
		jclass jcls) {
	jstring ener_string;
	double result = 0.0;
...
JNIEXPORT void JNICALL Java_UmCarroJaApp_ProfileDealloc
