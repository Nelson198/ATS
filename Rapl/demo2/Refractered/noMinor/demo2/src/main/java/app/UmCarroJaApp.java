 ...
 * além de três menus principais, gerados a partir da classe View.Menu.
 * 
 * 
 * 
 * 
...
public class UmCarroJaApp{
    ...
    /* View.Menu inicial da aplicação */
    private static Menu menuInicial;
    /* View.Menu dos utilizadores da aplicação */
    private static Menu menuUtilizador;
    /* View.Menu do administrador da aplicação */
    private static Menu menuAdmin;
    /* View.Menu do proprietário */
 ...
 public native static int scale(int freq);
    ...
    /**
     * Inicia os diferentes Menus da aplicação, respetivamente o View.Menu Inicial,
     * o View.Menu do Proprietário e o View.Menu do Model.Cliente.
     */
    private static void initMenus(){
        String[] inicial =      {"View.Menu Inicial",
                                 "View.Menu Model.Utilizador",
                                 "View.Menu Administração",
                                 "Guardar Dados da Aplicação"};
                                 
        String[] utilizador =   {"View.Menu Model.Utilizador",
                                 "Iniciar Sessão", 
                                 "Registar Model.Utilizador"};
                                 
        String[] admin =        {"View.Menu Administração",
        ...
        String[] proprietario = {"View.Menu Proprietário",
                                 "Registar Viatura",
        ...
        String[] cliente =      {"View.Menu Model.Cliente",
    ...
    private static void menuUtilizador(){
        ...
        } while(menuUtilizador.getOpcao() != 0 && menuUtilizador.getOpcao() > 3);
    }
    ...
    private static void extratoAluguerViatura(){
        ...
        do {
            ...
            out.print("Digite a Data de Fim de Model.Aluguer (dd-mm-aaaa): ");
        ...
        } catch(VeiculoNaoExisteException | CloneNotSupportedException e) {
    ...
    private static void clientesComMaisKm(){
        ...
        catch(NaoExistemClientesException | CloneNotSupportedException e){
    ...
    private static void sessaoProprietario() throws CloneNotSupportedException {
        do{
            classificarClientes();
            clearScreen();
    ...
    private static void classificarClientes() throws CloneNotSupportedException {
    ...
    private static void registarVeiculoProp(){
       ...
       while(existe){
        ...
        catch (VeiculoJaExisteException | CloneNotSupportedException e) {
            out.println("O Model.Veiculo " + e.getMessage() +  " já está registado!\n");
        }
    }   
    ...
    private static void setVeiculoDisponivel(){
        ...
        try {
            ...
            out.println("O Model.Veiculo " + e.getMessage() +  " não existe!\n");
        }
        catch (VeiculoNaoESeuException e2) {
            out.println("O Model.Veiculo " + e2.getMessage() +  " não lhe pertence!\n");
        }
    }
    ...
    private static void getListaDeAlugueres() throws CloneNotSupportedException {
    ...
    private static void analisarAlugueres() throws CloneNotSupportedException {
    ...
    public static void suplementoPrecoAlug(){
        ...
        try {
            ...
            out.println("O Model.Veiculo " + e.getMessage() +  " não lhe pertence!\n");
        }
    ...
    private static List<Aluguer> filterAlugueresBD (List<Aluguer> alugs, GregorianCalendar dataInicio, GregorianCalendar dataFim) throws CloneNotSupportedException {
    ...
    private static void meusAlugueresEntreDatasProp() throws CloneNotSupportedException {
        ...
        do {
            out.print("Digite a Data de Início do Model.Aluguer (dd-mm-aaaa): ");
            dataInicio = Input.lerData("Data de Início Inválida!", "Digite Novamente a Data de Início (dd-mm-aaaa): ");

            out.print("Digite a Data de Fim do Model.Aluguer (dd-mm-aaaa): ");
            dataFim = Input.lerData("Data de fim inválida!", "Digite Novamente a Data de Fim (dd-mm-aaaa): ");
        }while(dataFim.before(dataInicio));
    ...
    private static void sessaoCliente() throws CloneNotSupportedException {
        do{
            classificarVeiculos();
            UmCarroJaApp.clearScreen();
            menuCliente.executa();
    ...
    private static void classificarVeiculos() throws CloneNotSupportedException {
    ...
    private static void aluguerMaisProximo() throws CloneNotSupportedException {
        ...
        do{
            out.print("Digite a Data de Início do Model.Aluguer (dd-mm-aaaa): ");
            dataInicio = Input.lerData("Data de Início de Model.Aluguer Inválida!", "Digite Novamente a Data de Início de Model.Aluguer (dd-mm-aaaa): ");

            out.print("Digite a Data de Fim de Model.Aluguer (dd-mm-aaaa): ");
            dataFim = Input.lerData("Data de Fim de Model.Aluguer Inválida!", "Digite novamente a Data de Fim de Model.Aluguer (dd-mm-aaaa): ");
        ...
        catch(NaoExistemVeiculosDisponiveisException | CloneNotSupportedException e){
    ...
    private static void aluguerMaisBarato() throws CloneNotSupportedException {
        GregorianCalendar dataInicio;
        GregorianCalendar dataFim;
        int quantos;
        String matricula;
        ...
        do {
            out.print("Digite a Data de Início de Model.Aluguer (dd-mm-aaaa): ");
            dataInicio = Input.lerData("Data de Início de Model.Aluguer Inválida!", "Digite Novamente a Data de Início de Model.Aluguer (dd-mm-aaaa): ");

            out.print("Digite a data de fim de aluguer (dd-mm-aaaa): ");
            dataFim = Input.lerData("Data de Início de Model.Aluguer Inválida!", "Digite Novamente a Data de Fim de Model.Aluguer (dd-mm-aaaa): ");
        }while (!verificaData(dataInicio, dataFim));
    ...
    private static void aluguerMaisBaratoPerimetro() throws CloneNotSupportedException {
        GregorianCalendar dataInicio;
        GregorianCalendar dataFim;
        int quantos;
        String matricula;
    ...
    private static void aluguerVeiculoEspecifico() throws CloneNotSupportedException {
        GregorianCalendar dataInicio;
        GregorianCalendar dataFim;
        String matricula;
        double latitude;
    ...
    private static void aluguerDeterminadaAutonomia() throws CloneNotSupportedException {
    ...
    private static void meusAlugueresEntreDatasCli() throws CloneNotSupportedException {
        List<Aluguer> alugs = new ArrayList<>();
   ...
   private static void parseAluguer(String linha) throws CloneNotSupportedException {
        String mail;
        double x;
        double y;
       ...
       Veiculo v = new Veiculo();
        ...
        if (dados[4].equals("MaisBarato")){
            ...
            if (dados[3].equals("Electrico")){
                try{
                    v = ucj.maisPertoJa(cli.getPosicao().clone(), cords.clone(), datas, "Model.CarroEletrico");
                }catch(NaoExistemVeiculosDisponiveisException e){
                    out.println("Não existem veículos disponíveis para alugar!\n");
                }
            }
            if (dados[3].equals("Hibrido")){
                try{
                    v = ucj.maisPertoJa(cli.getPosicao().clone(), cords.clone(), datas, "Model.CarroHibrido");
                }catch(NaoExistemVeiculosDisponiveisException e){
                    out.println("Não existem veículos disponíveis para alugar!\n");
                }
            }
            if (dados[3].equals("Gasolina")){
                try{
                    v = ucj.maisPertoJa(cli.getPosicao().clone(), cords.clone(), datas, "Model.CarroGasolina");
                }catch(NaoExistemVeiculosDisponiveisException e){
                    out.println("Não existem veículos disponíveis para alugar!\n");
                }
            }
    ...
    public static void parseClassificar(String linha) throws CloneNotSupportedException {
        String [] dados = linha.split(",");
        int classificacao = 0;
