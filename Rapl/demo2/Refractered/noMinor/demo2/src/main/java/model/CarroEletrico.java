...
public class CarroEletrico extends Veiculo{
     ...
     * É criada uma instância da classe Model.CarroEletrico.
     */
     ...
     * @param classif     Utils.Classificacao do carro elétrico.
     ...
     * @return Model.CarroEletrico Um novo carro elétrico, que é cópia do this.
     */
    public CarroEletrico clone() throws CloneNotSupportedException {
        return (CarroEletrico) super.clone();
    }  
}