...
public class UmCarroJa implements Serializable {
    ...
    /* Model.Utilizador que efetuou o login */
     ...
     * É criada uma instância da classe Model.UmCarroJa.
     */
    public UmCarroJa(){
     ...
     * @return Model.Utilizador Devolve o utilizador correspondente ao email recebido como parâmetro, caso este exista.
     */
    public Utilizador getUtilizador(String email) throws UtilizadorNaoExisteException, CloneNotSupportedException {
    ...
    /**
     * Método que devolve a posição do utilizador que está logado (Model.Cliente).
     * @return Utils.Coordinate Devolve a posição do utilizador que tem sessão iniciada.
     */
    public Coordinate getPosicaoCliente() throws CloneNotSupportedException {
     ...
     *  
     * @param user Model.Utilizador que se pretende registar.
     */
    public void registarUtilizador(Utilizador user) throws UtilizadorJaExisteException, CloneNotSupportedException {
     ...
     */
    public void iniciarSessao(String email, String password) throws UtilizadorNaoExisteException, PasswordIncorretaException, CloneNotSupportedException {
        if (!(this.utilizadores.containsKey(email))){
            throw new UtilizadorNaoExisteException(email);
        }
     ...
     * @return List<Model.Aluguer> Lista de alugueres de um veículos.
     */
    public List<Aluguer> getAlugueresVeiculo(String matricula)  throws VeiculoNaoExisteException{
        ...
        if(aux != null){
            return aux.stream().map(aluguer -> {
                try {
                    return aluguer.clone();
     ...
     * @return List<Model.Cliente> Lista dos 10 clientes com mais Km percorridos.
     */
    public List<Cliente> get10ClientesKm() throws NaoExistemClientesException, CloneNotSupportedException {
     ...
     * @throws NaoExistemClientesException Exceção caso não existam clientes.
     * @return List<Model.Cliente> Lista dos 10 clientes com mais alugueres efetuados.
     */
    public List<Cliente> get10ClientesAlugueres() throws NaoExistemClientesException, CloneNotSupportedException {
        List<Cliente> cli = new ArrayList<>();
        for(Utilizador u: this.utilizadores.values()){
            if(u instanceof Cliente){
                Cliente c = (Cliente) u;
     ...
     *
     * @return List<Model.Aluguer> Lista com os alugueres para o proprietário classificar o cliente.
     */
     ...
     * @param alug           Model.Aluguer a classificar o cliente.
     * @param classif        Utils.Classificacao a atribuir.
     */
     public void classificarCliente(Aluguer alug, int classif) throws CloneNotSupportedException {
     ...
     */
    public void registarVeiculo(Veiculo v) throws VeiculoJaExisteException, CloneNotSupportedException {
     ...
     */
    public List<Aluguer> getAlugueresProp(String chave) throws CloneNotSupportedException {
     ...
     */
    public List<Aluguer> determinarListaEspera(String chave) throws CloneNotSupportedException {
     ...
     * @param alug  Model.Aluguer ao qual recebeu resposta do proprietário.
     */
     ...
     * @param mail  Email do Model.Cliente.
     */
    public List<Aluguer> determinarListaAlugCli(String matricula, String mail) throws VeiculoNaoESeuException, UtilizadorNaoExisteException{
        ...
        List<Aluguer> alugs = this.alugueres.get(user.getNIF()).get(matricula).stream().map(aluguer -> {
            try {
                return aluguer.clone();
            } catch (CloneNotSupportedException e) {
                e.printStackTrace();
     ...
     * @param alug  Model.Aluguer ao qual o seu preço vai ser alterado.
     */
     ...
     * É feito um varrimento completo e feita a verificação acerca do estado da classificação.
     *
     * @return List<Model.Aluguer> Lista com os alugueres para o cliente classificar o veículo.
     */
     ...
     * @param classif        Utils.Classificacao a atribuir.
     */
    public void classificarVeiculo(Aluguer alug, int classif) throws CloneNotSupportedException {
     ...
     *
     * @param alug Model.Aluguer que se pretende registar.
     */
    public void registaAluguer(Aluguer alug) throws CloneNotSupportedException {
        ...
        catch (NullPointerException | CloneNotSupportedException exc){
            alugs = new HashMap<>();
            List<Aluguer> alugsPropVeiculo = new ArrayList<>();
            alugsPropVeiculo.add(alug.clone());
            alugs.put(matricula, alugsPropVeiculo);
    ...
    private List<Veiculo> disponiveisAlugar(Coordinate destino, ParDatas date){
        return this.veiculos.values().stream().filter(v -> v.getDisponibilidade() &&
                ...
                && autonomiaSuf(v,destino)).map(veiculo -> {
            try {
     ...
     */
    public List<Veiculo> maisProximo(Coordinate destino, ParDatas date, int quantos) throws NaoExistemVeiculosDisponiveisException, CloneNotSupportedException {
     ...
     * @return List<Model.Veiculo> Lista com os veículos mais baratos.
     */
    public List<Veiculo> maisBarato(Coordinate destino, ParDatas date, int quantos) throws NaoExistemVeiculosDisponiveisException, CloneNotSupportedException {
     ...
     * calculada a distancia entre o Model.Cliente e o Model.Veiculo e são apresentados os veiculos cuja
     ...
     * @param quantos   Número de veículos que o cliente deseja ver.
     * @throws NaoExistemVeiculosDisponiveisException Excepção caso não existam veículos disponíveis.
     * @return List<Model.Veiculo> Lista com os veículos mais baratos num perímetro.
     */
    public List<Veiculo> maisBaratoNoPerimetro (Coordinate destino, Coordinate cordsCli, ParDatas date, double perimetro, int quantos) throws NaoExistemVeiculosDisponiveisException, CloneNotSupportedException {
    ...
    /**
     * Método responsável por devolver o Model.Veiculo em especifico requisitado pelo cliente.
     * Caso o veiculo não exista , devolve Exceptions.VeiculoNaoExisteException.
     ...
     * @return Model.Veiculo O veículo a alugar.
     */
    public Veiculo veiculoEspecifico(Coordinate destino, ParDatas date, String id) throws VeiculoNaoExisteException, VeiculoIndisponivelException, CloneNotSupportedException {
     ...
     * @return List<Model.Veiculo> Lista ordenada com os veículos que têm a autonomia desejada.
     */
    public List<Veiculo> determinadaAutonomia (Coordinate destino, ParDatas date, int val1, int val2, int quantos) throws NaoExistemVeiculosDisponiveisException, CloneNotSupportedException {
    ...
    */
   public List<Aluguer> getAlugueresCliente(String mail) throws NaoEfetuouNenhumAluguerException, CloneNotSupportedException {
    ...
    **********************************************************************************/
     ...
     */
    public Veiculo maisPertoJa(Coordinate posCli, Coordinate destino, ParDatas date, String combustivel) throws NaoExistemVeiculosDisponiveisException, CloneNotSupportedException {
        List<Veiculo> veiculosOrdenados = new ArrayList<>();
        ...
        /*veiculosOrdenados.sort(new Comparator<Model.Veiculo>(){
            public int compare(Model.Veiculo a1, Model.Veiculo a2) {
                if (a1.getPosicao().getDistancia(posCli) < a2.getPosicao().getDistancia(posCli)) {
                    return 1;
                }
                if (a1.getPosicao().getDistancia(posCli) > a2.getPosicao().getDistancia(posCli)){
     ...
     * @param date  Intervalo de datas em que o cliente pretende o aluguer.
     * @param combustivel Tipo de combustível.
     * @return Model.Veiculo Veículo mais barato.
     */
    public Veiculo maisBaratoJa(Coordinate dest, ParDatas date, String combustivel) throws NaoExistemVeiculosDisponiveisException, CloneNotSupportedException {
        List<Veiculo> veiculosOrdenados = new ArrayList<>();
    ...
    public void classificarClienteJa(String mail, int classificacao){
        try{
            ...
            if (u instanceof Cliente){
                ...
                int classificAnterior = cli.getClassificacao();
                double novaClassificacao = (classificAnterior + classificacao) / (double) (nAlugs);
                Long c = Math.round(novaClassificacao);
                int classifiFinal = Integer.valueOf(c.intValue());
                cli.setClassificacao(classifiFinal);
                this.utilizadores.replace(cli.getEmail(), cli.clone());
            }   
        }catch (UtilizadorNaoExisteException | CloneNotSupportedException e){
        }
    }

    public void classificarVeiculoJa(String matricula, int classificacao) throws CloneNotSupportedException {
        Veiculo v = this.veiculos.get(matricula);
    ...
    /**
     * Grava os campos da instância Model.UmCarroJa e a data da aplicação num ficheiro objeto.
     */
