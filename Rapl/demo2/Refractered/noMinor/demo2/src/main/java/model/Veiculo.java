...
public class Veiculo implements Serializable, Classificacao {
    ...
    /* Utils.Classificacao do veículo */
    private int classificacao;
    /* Instância da classe Model.ParDatas que representa um par de datas, data de início e fim de um aluguer, efetuado */
    private List<ParDatas> datasAlugueres;
    
    /**
     * Construtor por omissão.
     * É criada uma instância da classe Model.Veiculo.
     */
    public Veiculo(){
        this.marca = "";
        this.matricula = "";
     ...
     * @param classif     Utils.Classificacao do veículo.
    ...
    public Veiculo(String marca, String matricula, String nif, int velocidade, double preco, double consumo,
        ...
        this.datasAlugueres = datasAlugs.stream().map(parDatas -> {
            try {
                return parDatas.clone();
     ...
     * @return Utils.Coordinate Representa a posição onde se encontra o veículo.
     */
     ...
     * @return List<Model.ParDatas> Representa a lista de pares de datas de alugueres.
     */
    public List<ParDatas> getDatasAlugueres(){return this.datasAlugueres.stream().map(parDatas -> {
        try {
            return parDatas.clone();
        } catch (CloneNotSupportedException e) {
            e.printStackTrace();
     ...
     */
    public void setDatasAlugueres(List<ParDatas> datas){this.datasAlugueres = datas.stream().map(parDatas -> {
        try {
            return parDatas.clone();
        } catch (CloneNotSupportedException e) {
            e.printStackTrace();
     ...
     */
    public int tempoAteVeiculoPe(Coordinate posicaoCli, Weather weath){
    ...
    public String toString(){
       ...
       str.append("Utils.Classificacao: "); str.append(this.classificacao); str.append("\n");
     ...
     * @return Model.Veiculo Um novo veículo, que é cópia do this.
     */
