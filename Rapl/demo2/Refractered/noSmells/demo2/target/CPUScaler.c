...
JNIEXPORT jint JNICALL Java_app_UmCarroJaApp_ProfileInit(JNIEnv *env, jclass jcls) {
	jintArray result;
	int i;
	...
	/*only two doapp_UmCarroJaApps are supported for parameters check*/
...
JNIEXPORT jint JNICALL Java_app_UmCarroJaApp_GetSocketNum(JNIEnv *env, jclass jcls) {
	return (jint)getSocketNum();
}


JNIEXPORT jstring JNICALL Java_app_UmCarroJaApp_EnergyStatCheck(JNIEnv *env,
		jclass jcls) {
	jstring ener_string;
	double result = 0.0;
...
JNIEXPORT void JNICALL Java_app_UmCarroJaApp_ProfileDealloc
