        ...
        while(this.menu.getRun()) {
            switch (menu.getmMenu()) {
                ...
                case RegisterClient:
                    ...
                    catch (InvalidNewRegisterThrowable e){ error = "Parametros Inválidos"; }
                ...
                case Closest:
                    ...
                    catch (InvalidNewRentalThrowable e){error = "Novo Rental inválido"; }
                    break;
                case Cheapest:
                    try{
                        RentCarSimple rent = menu.simpleCarRent(error);
                ...
                case CheapestNear:
                    ...
                    catch (InvalidNewRentalThrowable e){error = "New rental inválido";}
                    catch (NoCarAvaliableException e)  {error = "No cars availables"; }
                    break;
                ...
                case Specific:
                    ...
                    catch (InvalidNewRentalThrowable e) { error = "Invalid Parameters"; }
                    break;
                ...
                case CarOverview:
                    ...
                    try {
                        switch (action.charAt(0)) {
                            ...
                            case'c':
                                ...
                                if (s.length != 2)
                                    throw new InvalidNumberOfArgumentsThrowable();
                    ...
                    catch (InvalidNumberOfArgumentsThrowable e) {error = "Invalid parameters";}
