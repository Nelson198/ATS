...
public class CarroGasolina_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "CarroGasolina"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(CarroGasolina_ESTest_scaffolding.class.getClassLoader() ,
      "Weather",
      "Coordinate",
      "Classificação",
      "ParDatas",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(CarroGasolina_ESTest_scaffolding.class.getClassLoader()); 
