...
public class CarroHibrido_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "CarroHibrido"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(CarroHibrido_ESTest_scaffolding.class.getClassLoader() ,
      "Weather",
      "Coordinate",
      "Classificação",
      "ParDatas",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(CarroHibrido_ESTest_scaffolding.class.getClassLoader()); 
