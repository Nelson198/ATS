...
public class ComparadorAutonomia_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "ComparadorAutonomia"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(ComparadorAutonomia_ESTest_scaffolding.class.getClassLoader() ,
      "Weather",
      "Coordinate",
      "Classificação",
      "ParDatas",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(ComparadorAutonomia_ESTest_scaffolding.class.getClassLoader()); 
