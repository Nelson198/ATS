...
public class UmCarroJaApp{
    ...
    static final String MATRICULA_INVALIDA = "Matricula inválida!";
    static final String DATA_INICIO_ALUGUER_INVALIDA = "Data de início de aluguer inválida!";
    static final String DATA_FIM_ALUGUER_INVALIDA = "Data de fim de aluguer inválida!";
    ...
    static final String DIGITAR_MATRICULA_ALUGAR = "Introduza a matrícula do veículo que pretende alugar ";
    static final String DIGITAR_DATA_FIM_ALUGUER = "Digite a data de fim de aluguer (dd-mm-aaaa): ";
    static final String DIGITAR_DATA_INICIO_ALUGUER = "Digite a data de início de aluguer (dd-mm-aaaa): ";
        ...
        do{
            ...
            switch(menuInicial.getOpcao()){
                ...
                case 3: guardarDados();
                    break;
                default:
                    throw new IllegalStateException(UNEXPECTED_VALUE + menuInicial.getOpcao());
            }
        ...
        do{
            ...
            switch(menuUtilizador.getOpcao()){
                ...
                case 2: registarUtilizador();
                    break;
                default:
                    throw new IllegalStateException(UNEXPECTED_VALUE + menuUtilizador.getOpcao());
            }
        ...
        do{
            ...
            switch(menuAdmin.getOpcao()){
                ...
                case 3: clientesComMaisKm();
                    break;
                default:
                    throw new IllegalStateException(UNEXPECTED_VALUE + menuAdmin.getOpcao());
            }
    ...
    private static void extratoAluguerViatura(){
        ...
        matricula = Input.lerString("Matrícula Inválida!", MATRICULA_DENOVO);
        ...
        do{
            ...
            switch(menuProprietario.getOpcao()){
                ...
                case 8: calcFactBDates();
                        break;
                default:
                    throw new IllegalStateException(UNEXPECTED_VALUE + menuProprietario.getOpcao());
            }
    ...
    private static void registarVeiculoProp(){
       ...
       while(existe){
        ...
        try {
            ...
            out.println(VEICULO + e.getMessage() +  " já está registado!\n");
        }
    }   
    ...
    public static void suplementoPrecoAlug(){
        ...
        if(alugs.isEmpty()){
            ...
            for(Aluguer a : alugs) {
                ...
                flag = true;
                while(rep && flag) {
                    out.print("Digite o preço para aluguer: ");
        ...
        do{
            ...
            switch(menuCliente.getOpcao()){
                ...
                case 6: meusAlugueresEntreDatasCli();
                        break;
                default:
                    throw new IllegalStateException(UNEXPECTED_VALUE + menuCliente.getOpcao());
            }
    ...
    private static void aluguerMaisProximo(){
        ...
        try{
            ...
            out.println(NAO_EXISTE_VEICULO_DISPONIVEL + ", Com os Critérios Inseridos!");
        }
        ...
        do{
            out.print(DIGITAR_MATRICULA_ALUGAR);
            matricula = Input.lerString(MATRICULA_INVALIDA, MATRICULA_DENOVO);
    ...
    private static void aluguerVeiculoEspecifico(){
        ...
        out.print(DIGITAR_LONGITUDE_DESTINO);
        longitude = Input.lerDouble("Longitude Inválida!", LONGITUDE_DENOVO);
