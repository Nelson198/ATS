...
public class StringBetter_ESTest_scaffolding {
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(StringBetter_ESTest_scaffolding.class.getClassLoader() ,
      "Utils.StringBetter"
    );
  } 

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(StringBetter_ESTest_scaffolding.class.getClassLoader()); 
