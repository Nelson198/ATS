...
public class Aluguer implements Serializable {
    ...
    /* Destino do Model.Cliente */
    private Coordinate destino;
    /* Número de Kms desde a origem até ao destino */
    private double distancia;
    /* Model.Aluguer foi aceite pelo proprietário ou não */
    private boolean aceite;
    /* Model.Aluguer está em lista de espera ou não */
    private boolean listaEspera;
    /* Model.Aluguer já foi realizado ou não */
    private  boolean realizado;
    /* Model.Aluguer foi alterado de preço ou não */
     ...
     * É criada uma instância da classe Model.Aluguer.
     */
    public Aluguer(){
        this.mail = "";
        this.matricula = "";
     ...
     * @param dest           Destino do Model.Cliente.
     ...
     * @return Utils.Coordinate Representa as coordenadas de destino do cliente.
     */
    ...
    public String toString() {
       ...
       str.append("*****    ALUGUER    *****\n"); 
       str.append("Mail do Model.Cliente: "); str.append(this.mail); str.append("\n");
       ...
       str.append("Model.Aluguer Aceite pelo Proprietário: "); str.append(this.aceite); str.append("\n");
       str.append("Model.Aluguer em lista de espera: "); str.append(this.listaEspera); str.append("\n");
       str.append("Model.Aluguer Realizado: "); str.append(this.realizado); str.append("\n");
     ...
     * @return Model.Aluguer Um novo aluguer que é cópia do this.
     */
    public Aluguer clone() throws CloneNotSupportedException {
        return (Aluguer) super.clone();
    }  
}
