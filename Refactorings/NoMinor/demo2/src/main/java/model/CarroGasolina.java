...
public class CarroGasolina extends Veiculo{
     ...
     * É criada uma instância da classe Model.CarroGasolina.
     */
     ...
     * @param classif     Utils.Classificacao do carro a gasolina.
     ...
     * @return Model.CarroGasolina Um novo carro a gasolina, que é cópia do this.
     */
    public CarroGasolina clone() throws CloneNotSupportedException {
        return (CarroGasolina) super.clone();
    }  
}
