...
public class CarroHibrido extends Veiculo{
     ...
     * É criada uma instância da classe Model.CarroHibrido.
     */
    public CarroHibrido(){
        super();
    }
     ...
     * @param classif     Utils.Classificacao do carro híbrido.
     ...
     * @return Model.CarroHibrido Um novo carro híbrido, que é cópia do this.
     */
    public CarroHibrido clone() throws CloneNotSupportedException {
        return (CarroHibrido) super.clone();
    }  
}