...
public class ParDatas implements Serializable {
     ...
     * É criada uma instância da classe Model.ParDatas.
     */
    public ParDatas(){
     ...
     * @return Model.ParDatas Um novo par de datas que é cópia do this.
     */
    public ParDatas clone() throws CloneNotSupportedException {
        return (ParDatas) super.clone();
    }
}
