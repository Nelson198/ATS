...
\begin{itemize}
    ...
    \textbf{Use static access with "java.util.Calendar" for "DAY_OF_MONTH"}, ou equivalente.
    ...
    Com o \textit{IntelliJ}, é possível selecionar o membro e carregar na opção "\textit{Add static import for "java.util.Calendar.DAY_OF_MONTH"}".\\
    ...
    \textbf{Rename this field "MIN_LATITUDE" to match the regular expression '^[a-z][a-zA-Z0-9]*$'}, ou equivalente.
...
\subsection{Versão 1 - \textit{demo1}}
Após as diversas alterações e eliminações de smells era necessáiro verificar que estas tiveram impacto sobre a funcionalidade do programa. Para tal foi utilizada a ferramenta RAPL, disponiblizada pelos docentes, para analisar o consumo energético do programa. Como primeira etapa foram registados os valores energéticos com logs de diversos tamanhos (5,55,5555). De seguida encontram-se as tabelas com os resultados obtidos

\begin{table}[h] 
    \caption{Análise do consumo energético - \textit{demo1}}
    \begin{center}
        \begin{tabular}{>{\centering}p{0.1\textwidth}>{\centering}p{0.15\textwidth}>{\centering}p{0.2\textwidth}>{\centering}p{0.22\textwidth}>{\centering\arraybackslash}p{0.2\textwidth}}
...
\begin{table}[h] 
    ...
    \begin{center}
        \begin{tabular}{>{\centering}p{0.1\textwidth}>{\centering}p{0.15\textwidth}>{\centering}p{0.2\textwidth}>{\centering}p{0.22\textwidth}>{\centering\arraybackslash}p{0.2\textwidth}}
        \toprule \textbf{\textit{Smells}?} & \textbf{Tamanho do \textit{input}} & \textbf{\textit{dram}} (em \textit{MB}) & \textbf{\textit{cpu}} (em \textit{ms}) & \textbf{\textit{package}} (em \textit{J}) \\
        \midrule Sim & orignal & 2.5678709999999683 & 30.438354000000004  &  41.03033400000004\\
        \midrule Não &  &  &  &  \\
        \bottomrule
        \end{tabular} 
    \end{center}
...
\begin{table}[h] 
    ...
    \begin{center}
        ...
        \midrule \textit{noMajor} & orignal & 2.204895000000306 & 24.839966000000004 & 34.237121999998635   \\
