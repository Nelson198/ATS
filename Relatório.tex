...
Para além dos \textit{code smells}, desenvolveu-se mais uma versão para este \textit{demo1}. 
...
\begin{table}[h] 
    ...
    \begin{center}
        ...
        \hline
        Model & 100\% (13/13) & 83\% (134/160) & 77\% (515/661) \\
        \hline
...
\label{sec:rapl}
\subsection{Versão 1 - \textit{demo1}}
Após as diversas alterações e eliminações de \textit{smells} é necessário verificar se estas tiveram impacto sobre o desempenho do programa. Para tal foi utilizada a ferramenta \textit{RAPL}, disponibilizada pelos docentes, para analisar o consumo energético do programa. Como primeira etapa foram registados os valores energéticos com \textit{logs} de diversos tamanhos (5, 55, 5555, 55555). Dado que o log de tamanho 55555 foi o único onde se obteve resultados significativos, foram executadas 25 medições na ferramenta computacional \textit{RAPL}. Após estas medições, foram calculadas as respetivas médias com a utilização do utensílio \textit{LibreOffice Calc}. Assim foi possível obter resultados mais reais e, por sua vez, mais credíveis (\textbf{nota:} todas as medições e as respetivas médias podem ser consultadas no ficheiro \textit{"average.ods"} dentro da pasta \texttt{Rapl}). De seguida encontram-se as tabelas que exprimem os resultados obtidos:
...
\begin{table}[h] 
    ...
    \begin{center}
        ...
        \midrule Não &  5555 &  0.32525699999996505  &  3.6011349999999993 & 5.260498000000098 \\
         \midrule \\
        \midrule Sim &  55555 & 4,14223628000001 &   67,9725096 & 99,4849608799997 \\
        \midrule Não &  55555 & 4,28174800000001  &  71,39076412  & 104,18206552 \\
        \bottomrule
        \end{tabular} 
    \end{center}
\end{table}
...
\begin{table}[h] 
    ...
    \begin{center}
        ...
        \midrule \textit{noMinor} & 15,56374756 & 215,36804928 & 367,53493424 & 17707,64 \tabularnewline
        \midrule \textit{noMajor} & 14,40567876 & 209,67994132 & 362,36744884 & 17172,68 \tabularnewline
        \midrule \textit{noCritical} & 15,7627222 & 220,7968776 & 377,96918212 & 17883,44\tabularnewline
        \midrule \textit{noBlocker} & 16,49993656 & 219,789878 & 372,12416748 & 17710,04 \tabularnewline
        \midrule \textit{noRedSmells} & 15,19409168 & 213,9433984 & 369,34534428 & 17924,64  \tabularnewline
        \midrule \textit{noSmells} & 14,49961668 & 205,08033472 & 355,16195064 &  17441,96  \tabularnewline
        \bottomrule
        \end{tabular} 
    \end{center}
\end{table}
