...
\label{sec:rapl}
\subsection{Versão 1 - \textit{demo1}}
Após as diversas alterações e eliminações de \textit{smells} é necessário verificar se estas tiveram impacto sobre o desempenho do programa. Para tal foi utilizada a ferramenta \textit{RAPL}, disponibilizada pelos docentes, para analisar o consumo energético do programa. Como primeira etapa foram registados os valores energéticos com \textit{logs} de diversos tamanhos (5, 55, 5555, 55555).Como apenas o log de tamanho 55555 obteve resultados significativos, para este foram utilizadas 25 medições e calculado as suas médias, com a frramenta LibreOffice Calc, para obter resultados mais crediveis(todas as medições e as suas médias podem ser consultadas no ficheiro "average.ods" dentro da pasta Rapl). De seguida encontram-se as tabelas com os resultados obtidos:
